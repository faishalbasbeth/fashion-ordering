	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="?controller=pemesanan&action=pemesanan">Fauzia Collection</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="?controller=pemesanan&action=pemesanan">Pemesanan</a></li>
            <li><a href="?controller=pemesanan&action=tampilAddPemesanan">Tambah Data</a></li>
            <li><a href="?controller=b_pembayaran&action=Bpembayaran">Bukti Pembayaran</a></li>
          </ul>
        </div>
